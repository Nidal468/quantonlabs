      ...
      {items.slice(0, max).map((item, i) => (
        <div
          ...
          style={{
            ...
            fontSize: 11, fontWeight: item.urgent ? 700 : 500,
...
<div className="ql-window-wrap" style={{      background: "linear-gradient(135deg, #F8FAFF 0%, #EEF2FF 100%)",
      ...
      {/* Window chrome dots */}
        ...
        <div style={{ background: "#041227", padding: "9px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: "#fff", fontFamily: "Manrope, sans-serif" }}>Quanton OS Demo</div>
        ...
        {/* Narration strip */}
        <div style={{ background: "#fff", borderBottom: "1px solid #E2E8F0", padding: "10px 16px", display: "flex", alignItems: "flex-start", gap: 10 }}>
          <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#4655EB", marginTop: 6, flexShrink: 0 }} />
          <span key={narration} style={{ fontSize: 14, fontWeight: 500, color: "#374151", fontFamily: "Manrope, sans-serif", lineHeight: 1.5, animation: "narrFade 0.4s ease" }}>
            {narration}
          </span>
        </div>
