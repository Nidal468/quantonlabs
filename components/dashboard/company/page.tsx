...
import {
  Users, Bot, Key, Calendar, Shield, RefreshCw,
...
/**
 * Hero Section for Workspace Overview
 * Replaces the standard card with a more substantial header area.
 */
...
/**
 * Members Card with Avatar Grouping
 */
            ...
            <div className="flex flex-wrap gap-2">
              {workspace.members.slice(0, 6).map((member) => (
                <div key={member.id.toString()} className="group relative flex items-center justify-between w-full p-2 rounded-lg border border-gray-100 bg-white hover:border-blue-200 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    <div className="h-7 w-7 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-[10px] font-bold text-gray-600 shadow-sm ring-1 ring-black/5">
...
/**
 * Agents Card with System Status Visuals
 */
...
/**
 * Integrations Card with Connection Visuals
 */
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        {/* Row 2: Data Cards (Masonry-ish feel) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-6">
            <MembersCard workspace={activeCompany} />

            {/* Secondary Info Card - Just for visual balance in this demo */}
            <motion.div variants={itemVariants}>
